...
$(INSTALLED_BOOTIMAGE_TARGET): $(PRODUCT_OUT)/kernel $(recovery_ramdisk) $(INSTALLED_RAMDISK_TARGET) $(PRODUCT_OUT)/utilities/busybox $(MKBOOTIMG) $(MINIGZIP) $(INTERNAL_BOOTIMAGE_FILES)
	...
	$(hide) cp -R $(PRODUCT_OUT)/../../../../device/sony/kumquat/prebuilt/root/default.prop $(PRODUCT_OUT)/combinedroot/
	$(hide) cp -R $(PRODUCT_OUT)/../../../../device/sony/kumquat/recovery/init.rc $(PRODUCT_OUT)/recovery/root/
	...
	$(hide) python $(PRODUCT_OUT)/../../../../device/sony/kumquat/releasetools/mkelf.py -o $(PRODUCT_OUT)/kernel.elf $(PRODUCT_OUT)/kernel@0x00008000 $(PRODUCT_OUT)/combinedroot.fs@0x01000000,ramdisk $(PRODUCT_OUT)/../../../../device/sony/kumquat/prebuilt/cmdline@cmdline
	...
	$(hide) cat $(PRODUCT_OUT)/kernel.elf.bak3 $(PRODUCT_OUT)/../../../../device/sony/kumquat/prebuilt/elf.3 > $(PRODUCT_OUT)/kernel.elf.bak
